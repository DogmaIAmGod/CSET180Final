...
CREATE TABLE `cart` (
  ...
  PRIMARY KEY (`cart_id`),
  KEY `from_account_idx` (`account_id`),
...
INSERT INTO `cart` VALUES (1,1000,3),(2,1000,3),(3,1003,30),(6,1000,31),(8,1006,31),(10,1000,30),(11,1000,4),(12,1000,4),(13,1006,30),(14,1000,3),(15,1001,3),(16,1003,3),(17,1007,3);
